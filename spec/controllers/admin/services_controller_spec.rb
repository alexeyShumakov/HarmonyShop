...
RSpec.describe Admin::ServicesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all admin_services as @admin_services" do
      ...
      expect(assigns(:admin_services)).to eq([service])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested admin_service as @admin_service" do
      ...
      expect(assigns(:admin_service)).to eq(service)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new admin_service as @admin_service" do
      ...
      expect(assigns(:admin_service)).to be_a_new(Admin::Service)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Admin::Service" do
        expect {
          post :create, {:admin_service => valid_attributes}, valid_session
        }.to change(Admin::Service, :count).by(1)
      end

      it "assigns a newly created admin_service as @admin_service" do
        post :create, {:admin_service => valid_attributes}, valid_session
        expect(assigns(:admin_service)).to be_a(Admin::Service)
        expect(assigns(:admin_service)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved admin_service as @admin_service" do
        post :create, {:admin_service => invalid_attributes}, valid_session
        expect(assigns(:admin_service)).to be_a_new(Admin::Service)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_service" do
        service = Admin::Service.create! valid_attributes
        put :update, {:id => service.to_param, :admin_service => new_attributes}, valid_session
        service.reload
      ...
      it "assigns the requested admin_service as @admin_service" do
        service = Admin::Service.create! valid_attributes
        put :update, {:id => service.to_param, :admin_service => valid_attributes}, valid_session
        expect(assigns(:admin_service)).to eq(service)
      end
    ...
    context "with invalid params" do
      it "assigns the admin_service as @admin_service" do
        service = Admin::Service.create! valid_attributes
        put :update, {:id => service.to_param, :admin_service => invalid_attributes}, valid_session
        expect(assigns(:admin_service)).to eq(service)
      end
