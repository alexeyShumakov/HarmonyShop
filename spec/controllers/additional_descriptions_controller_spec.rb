...
RSpec.describe AdditionalDescriptionsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new AdditionalDescription" do
        expect {
          post :create, {:additional_description => valid_attributes}, valid_session
      ...
      it "redirects to the created additional_description" do
        post :create, {:additional_description => valid_attributes}, valid_session
        expect(response).to redirect_to(AdditionalDescription.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved additional_description as @additional_description" do
        post :create, {:additional_description => invalid_attributes}, valid_session
        expect(assigns(:additional_description)).to be_a_new(AdditionalDescription)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested additional_description" do
        additional_description = AdditionalDescription.create! valid_attributes
        put :update, {:id => additional_description.to_param, :additional_description => new_attributes}, valid_session
      ...
      it "assigns the requested additional_description as @additional_description" do
        additional_description = AdditionalDescription.create! valid_attributes
        put :update, {:id => additional_description.to_param, :additional_description => valid_attributes}, valid_session
        expect(assigns(:additional_description)).to eq(additional_description)
      end

      it "redirects to the additional_description" do
        additional_description = AdditionalDescription.create! valid_attributes
        put :update, {:id => additional_description.to_param, :additional_description => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns the additional_description as @additional_description" do
        additional_description = AdditionalDescription.create! valid_attributes
        put :update, {:id => additional_description.to_param, :additional_description => invalid_attributes}, valid_session
        expect(assigns(:additional_description)).to eq(additional_description)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the additional_descriptions list" do
      additional_description = AdditionalDescription.create! valid_attributes
      delete :destroy, {:id => additional_description.to_param}, valid_session
      expect(response).to redirect_to(additional_descriptions_url)
    end
  end
